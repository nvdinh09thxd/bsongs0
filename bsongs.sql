...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 23, 2019 lúc 03:25 PM
...
INSERT INTO `comments` (`id`, `id_song`, `username`, `comment`, `date_create`, `active`) VALUES
(1, 17, 'nvdinh185', 'bài hát đã sửa', '2018-09-11 10:03:04', 1),
(2, 17, 'toquyen', 'em yêu anh', '2018-08-17 08:32:02', 1),
...
(25, 17, '123456', '8888', '2019-12-12 13:54:27', 1),
(26, 11, 'nvdinh', 'only love', '2019-12-18 13:27:55', 1),
(27, 18, 'nvdinh', '123456', '2019-12-19 12:10:44', 1),
(28, 18, '111111', '111111111111', '2019-12-19 12:15:11', 1),
(29, 18, '123456', '999', '2019-12-19 12:16:58', 1),
(30, 18, 'fffffff', 'fffffffffff', '2019-12-19 12:32:20', 1);
...
(5, 'Cho đến mãi mãi', 'nvdinh185', 'wwwwwwwwwwwwwwwww', 'hhhhhhhhhhh'),
(6, 'ggggggggg', 'admin@gmail.com', 'wwwwwwwwwwww', '								ggggggggggggggggggggggggggggg													');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `hotnews`
--
...
--
-- Đang đổ dữ liệu cho bảng `hotnews`
--

INSERT INTO `hotnews` (`id`, `picture`, `link`, `sort`, `active`) VALUES
(1, 'quyen1.jpg', 'https://www.google.com/', 1, 1),
(2, 'quyen2.jpg', 'https://www.google.com/', 2, 1),
(3, 'quyen3.jpg', 'https://www.google.com/', 3, 0),
(4, 'quyen4.jpg', 'https://www.google.com/', 4, 0),
(5, 'quyen5.jpg', 'https://www.google.com/', 5, 0),
(8, 'dinh.jpg', 'https://www.google.com/', 6, 1),
(9, 'hh.jpg', 'https://www.google.com/', 7, 1);
...
INSERT INTO `rating` (`id_song`, `rating`, `count`, `date`) VALUES
(13, 2.42105, 19, '2019-12-18 14:53:06'),
(12, 5, 2, '2019-12-18 14:54:04'),
(9, 5.83333, 3, '2019-12-18 14:55:03'),
(18, 6.2, 10, '2019-12-19 12:32:30'),
(17, 6.375, 4, '2019-12-18 14:52:12'),
(2, 4, 6, '2019-12-18 13:15:36'),
(10, 5, 2, '2019-12-18 13:21:38'),
(6, 6, 2, '2019-12-18 13:24:33'),
(11, 6.4, 5, '2019-12-18 13:34:21'),
(16, 10, 1, '2019-12-18 13:46:56');
...
(7, 'Yêu em nhiều đến thế', 'Mình hợp nhau đến như vậy thế nhưng... không phải là yêu! \r\nVà em muốn hỏi anh rằng \"chúng ta là thế nào?\" \r\nRồi... lặng người đến vô tận, trách sao được sự tàn nhẫn \r\nAnh trót vô tình.. thương em như- là- em- gái... ', 'Mình hợp nhau đến như vậy thế nhưng... không phải là yêu! \r\nVà em muốn hỏi anh rằng \"chúng ta là thế nào?\" \r\nRồi... lặng người đến vô tận, trách sao được sự tàn nhẫn \r\nAnh trót vô tình.. thương em như- là- em- gái... ', '2019-12-12 12:48:37', 'java7.jpg', 12, 2),
(8, 'Tại sao', 'Mình hợp nhau đến như vậy thế nhưng... không phải là yêu! \r\nVà em muốn hỏi anh rằng \"chúng ta là thế nào?\" \r\nRồi... lặng người đến vô tận, trách sao được sự tàn nhẫn \r\nAnh trót vô tình.. thương em như- là- em- gái... ', 'Mình hợp nhau đến như vậy thế nhưng... không phải là yêu! \r\nVà em muốn hỏi anh rằng \"chúng ta là thế nào?\" \r\nRồi... lặng người đến vô tận, trách sao được sự tàn nhẫn \r\nAnh trót vô tình.. thương em như- là- em- gái... ', '2019-12-12 12:48:51', 'java8.jpg', 17, 2),
...
--
-- AUTO_INCREMENT cho bảng `hotnews`
--
ALTER TABLE `hotnews`
